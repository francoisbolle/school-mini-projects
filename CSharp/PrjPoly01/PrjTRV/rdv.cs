...
namespace PrjTRV
{
    public class rdv
    {
        ...
        protected void set_TypRdv(int t_TypRdv)
        {
        ...
        public virtual void set_Pstring(string t_string, bool VIju)
        {

        }

        public virtual string get_Pstring(bool VIju)
        {
            return "";
        }

        public virtual void set_Pbool(bool t_bool)
        {
            
        }

        public virtual bool get_Pbool()
        {
            return true;
        }
